...
namespace Sapwood.IO.FileFormats.Algorithms.UniGif
{
    public class UniGifLZW
    {
        /// <summary>
        /// GIF LZW decode
        /// </summary>
        ...
        public static byte[] DecodeGifLZW(List<byte> compData, int lzwMinimumCodeSize, int needDataSize)
        {
            ...
            while (bitDataIndex < bitData.Length)
            {
                ...
                {
                    // Exit
                    throw new Exception("early stop code. bitDataIndex:" + bitDataIndex + " lzwCodeSize:" + lzwCodeSize + " key:" + key + " dic.Count:" + dic.Count);
                    //break;
                }
                ...
                else if (key >= dic.Count)
                {
                    ...
                    {
                        throw new Exception("It is strange that come here. bitDataIndex:" + bitDataIndex + " lzwCodeSize:" + lzwCodeSize + " key:" + key + " dic.Count:" + dic.Count);
                        //bitDataIndex += lzwCodeSize;
                        //continue;
                    }
                }
